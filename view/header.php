    ...
    <header id="header" class="5grid-layout">
        ...
        <table width="97%" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;width:96% ;">
            <tr><td  align="left" style="overflow:hidden;"width="46%"><div class="headerLink"><img src="../images/Majorlogo.png"class="mobile_logo" width="300" height="88" alt="UCapture"/>  </div></td>
                ...
                <td  align="right" style=" overflow:hidden;vertical-align: middle;"width="50%"><br/><font color="#00ff00" >
                        <?php
                         //session_start();
                        if(!isset($_SESSION['user_id']))
                        { ?>
                        <a href="#login_form" id="login_pop" style="font-size: 100%;">LOGIN</a>/
                        <a href="userRegistration.php" id="join_pop" style="font-size: 100%;">SIGN UP</a></font><span class="signup_space"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br/><br/><br/>
                    <?php
                    }
                        ...
                        */?>
                        <form class="form-horizontal" action="../services/signin.php" method="POST">
                            ...
                            if(!isset($_SESSION['values']))
                            {
                                ...
                                <input type="submit" value="Log In" class="submit_btn"/>&nbsp;&nbsp;&nbsp;<a class="submit_btn" href="#close">Cancel</a>
                            <?php
                            }
                            else
                            {
